...
import gameObjects.menus.StartGamePanel;
...
public class Launcher {
    ...
    public Launcher(){
        ...
        this.jf.setTitle("Sundays at Dim Sum | By Fara Yan"); // setting the title of the JFrame window.
    ...
    private void initUIComponents(){
        ...
        this.startPanel = new StartGamePanel(this); // create a new start panel
        this.gamePanel = new ReefDisplay(this); // create a new game panel
        this.gamePanel.init(); // initialize game, but DO NOT start game
    ...
    public void setFrame(String type){
        ...
        switch(type){
            ...
            case "game":
                ...
                this.jf.setSize(GameConstants.WORLD_WIDTH,GameConstants.SCREEN_HEIGHT);
